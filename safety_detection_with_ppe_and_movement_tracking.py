# safety_detection_with_ppe_and_movement_tracking.py
...
# Track previous positions of each person
previous_positions = {}
movement_labels = {}  # Stores current movement status
...
while True:
    ...
    for track in tracks:
        ...
        # --- Movement Tracking ---
        prev_center = previous_positions.get(track_id)
        ...
        movement_labels[track_id] = movement_status
